  ...
  return (
    <section className="mt-12 css-color-2 w-4/5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8 mt-9">
        <div className="item">
          <div className="inset-0 m-0 h-full w-full overflow-hidden rounded-lg bg-transparent bg-[url('/dubai2.jpeg')] bg-cover bg-clip-border bg-center text-gray-700 shadow-none"></div>
        </div>
