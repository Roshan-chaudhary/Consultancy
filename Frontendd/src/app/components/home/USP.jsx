    ...
    <section className="mt-12 w-11/12">
      <div className="text-center">
        <p class="css-text-primary text-white text-5xl  css-family section-title">
          Welcome To The Aspire Global Education
        </p>
        ...
        <div className="flex justify-center">
          <p className="mt-8 w-5/6">
            Aspire Global Education has a long-standing reputation for being one
            of the best educational consultancy in Nepal for studying abroad
            specially Dubai, USA and UK. Our head office is located at Kalimati
            Chowk, Kathmandu, Nepal.
          </p>
        </div>
      </div>
